...
For a complete list of supported devices, check the [DeviceScreenSizes](https://github.com/ooow/ScreenSizeSim/blob/main/ScreenSizeSim/DeviceScreenSizes.swift) file in this repository.
